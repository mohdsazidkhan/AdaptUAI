          ...
          {error === 'INSUFFICIENT_AU' && (
            <div className="mt-2 flex flex-wrap gap-2">
              <a 
                ...
                className="px-3 py-1.5 bg-white border border-coral-200 rounded-xl text-[10px] font-black uppercase hover:bg-coral-100 transition-all flex items-center gap-1.5"
              >
              ...
              <a 
                ...
                className="px-3 py-1.5 bg-white border border-coral-200 rounded-xl text-[10px] font-black uppercase hover:bg-coral-100 transition-all flex items-center gap-1.5 shadow-sm"
              >
